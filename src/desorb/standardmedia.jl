...
function getstandardmedium(name::String; pressure::Float64=0.0, depth::Float64=0.0)
    ...
    elseif name == "Si"
        return AbsorberLayer((28,), (14,), (1,), 0.2329 * depth, 2.329)
    elseif name == "Graphite"
        return AbsorberLayer((12,), (6,), (1,), 0.2267 * depth, 2.267)
    elseif name == "C4H10"
        return GasAbsorber((12, 1), (6, 1), (4, 10), pressure, depth)
    elseif name == "CF4"
        return GasAbsorber((12, 19), (6, 9), (1, 4), pressure, depth)
    elseif name == "CH2"
        return AbsorberLayer((12, 1), (6, 1), (1, 2), 0.094 * depth, 0.94)
    elseif name == "CD2"
        return AbsorberLayer((12, 2), (6, 1), (1, 2), 0.094 * depth, 0.94)
    elseif name == "He"
